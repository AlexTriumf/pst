# Add necessary P/Invoke signatures for manual DLL loading
# First, check if the type already exists to avoid re-adding it.
...
"@
        Write-Host "[+] Successfully added MemoryLoader type."
    } catch {
